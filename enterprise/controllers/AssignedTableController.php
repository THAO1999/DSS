...
class AssignedTableController extends Controller
{
     ...
     */
    public function actionView($organization_request_id, $student_id)
    {
        // phpinfo();
        $model = new Students();
        $student = $model->getStudentProfiles($student_id);

        $list_StudentSkill = StudentSkillProfile::getSkill($student); // lay list skill student
